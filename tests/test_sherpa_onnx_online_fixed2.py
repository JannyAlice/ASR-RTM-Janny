"""
测试修复后的 Sherpa-ONNX 在线转录（使用官方方法）
"""
import os
import sys
import time
...
def test_sherpa_onnx_online_fixed():
    """测试修复后的 Sherpa-ONNX 在线转录"""
    print("测试修复后的 Sherpa-ONNX 在线转录（使用官方方法）...")
