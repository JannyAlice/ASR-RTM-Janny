"""
快速测试 sherpa-onnx-streaming-zipformer-en-2023-06-26 模型的文件转录功能
"""
import os
import sys
import time
...
def test_sherpa_0626_engine():
    """测试 sherpa-onnx-streaming-zipformer-en-2023-06-26 模型引擎"""
    print("=" * 80)
    print("测试 sherpa-onnx-streaming-zipformer-en-2023-06-26 模型引擎")
    print("=" * 80)
    ...
    if engine.setup():
        ...
        if result:
            ...
            output_file = os.path.join(project_root, "transcripts", f"transcript_0626_quick_{timestamp}.txt")
