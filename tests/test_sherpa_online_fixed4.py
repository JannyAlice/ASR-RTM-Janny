                    ...
                    try:
                        ...
                        if recognizer.AcceptWaveform(data):
                            ...
                            if "text" in result and result["text"]:
                                ...
                                # 检查内部变量
                                if hasattr(recognizer, 'current_text'):
                                    print(f"current_text: {recognizer.current_text}")
                                    # 保存到文件
                                    with open(transcript_file, "a", encoding="utf-8") as f:
                                        f.write(f"[current_text] {recognizer.current_text}\n")
